...
--
ALTER TABLE `delivery`
  MODIFY `delivery_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `item_adjustment`
  MODIFY `item_adj_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `item_tracking`
  MODIFY `item_tracking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `order_item_status`
  MODIFY `item_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `ws_payment_records`
  MODIFY `wsr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `ws_pending_payments`
--
ALTER TABLE `ws_pending_payments`
  MODIFY `wspp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
