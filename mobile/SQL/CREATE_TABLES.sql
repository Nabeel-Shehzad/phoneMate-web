...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 26, 2025 at 08:25 AM
...
--
ALTER TABLE `buyer`
  ADD CONSTRAINT `fk_buyer_bd_id` FOREIGN KEY (`fk_bd_id`) REFERENCES `business_developer` (`bd_id`),
  ADD CONSTRAINT `fk_buyer_rider_id` FOREIGN KEY (`fk_rider_id`) REFERENCES `rider` (`rider_id`);
