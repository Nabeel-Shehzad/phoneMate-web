...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        <h3 class="text-white-50">Records</h3>

        <div class="col-sm-12 col-xl-12">
            <div class="bg-secondary rounded h-100 w-100 p-4">
                <h4 class="mb-4">Company Earnings</h4>
                <div class="table-responsive">
                    <span class="text-custom">Search:</span>
                    <table id="company_earnings" style="background-color: #e74c3c;" class="table table-light table-bordered table-hover">
                        <thead>
                            <tr class="text-dark">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM company_earnings ORDER BY earning_id DESC";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>Rs. <?php echo $row['earning_amount']; ?></td>
                                        <td class="text-center">
                                            <a href="./c-earning-details.php?earning_id=<?php echo $row['earning_id']; ?>"
                                        ...
                                        <div class="row text-center">
                                            <div class="col-md-6 offset-md-3">
                                                <div class="alert alert-success"><strong>
                                                        No records of company earnings <?php echo $_SESSION['admin_name']; ?>, enjoy your day! &#x1F603;
                                                    </strong></div>
                                            </div>
                                        </div>
                                    </td>
