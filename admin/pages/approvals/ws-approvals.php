...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        <h3 class="text-white-50">New Registered Suppliers</h3>

        <div class="col-sm-12 col-xl-12">
            <div class="bg-secondary rounded h-100 w-100 p-4">
                <h4 class="mb-4">Approve Suppliers</h4>
                <div class="table-responsive">
                    <span class="text-custom">Search:</span>
                    <table id="supplier_approvals" style="background-color: #e74c3c;" class="table table-light table-bordered table-hover">
                        <thead>
                            <tr class="text-dark">
                                <!-- <th scope="col">#</th> -->
                        ...
                        <tbody>
                            ...
                            $query .= "Where ws_status='pending' ORDER BY ws_id DESC";
                            ...
                            ?>
                                    <tr>
                                        <td>
                                            <a href="#">
                                                <img class="rounded-circle" src="../../../uploads/ws-profile/<?php
                                                                                                                if ($row['ws_image'] == '') {
                                        ...
                                        <td>
                                            <a href="./approve-ws.php?ws_id=<?php echo $row['ws_id']; ?>" class="btn btn-square btn-outline-info m-2"><i class="fa fa-check" aria-hidden="true"></i></a>
                                            <!-- </form> -->
                                        </td>
                                    </tr>
                                <?php
                                        ...
                                        <div class="row text-center">
                                            <div class="col-md-6 offset-md-3">
                                                <div class="alert alert-success"><strong>
                                                        No new Suppliers for approval <?php echo $_SESSION['admin_name']; ?>, enjoy your day! &#x1F603;
                                                    </strong></div>
                                            </div>
                                        </div>
                                    </td>
