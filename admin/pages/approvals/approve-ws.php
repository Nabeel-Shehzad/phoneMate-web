...
if (isset($_POST['added'])) {
    $ws = new Wholesaler();
    $ws->ws_id = $_GET['ws_id'];
    $ws->ws_status = 'approved';

    if ($ws->update()) {
        redirect("./ws-approvals.php");
    }
}
?>
...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        <h3 class="text-white-50">Approve Supplier</h3>
        ...
        <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <div class="testimonial-item text-start">
                    ...
                    <p><strong class="text-white">Company Name:</strong> <?php echo $row['ws_company_name']; ?></p>
                    <p><strong class="text-white">Home Address:</strong> <?php echo $row['ws_home_address']; ?></p>
                    <p><strong class="text-white">Office Address:</strong> <?php echo $row['ws_office_address']; ?></p>
                    <p><strong class="text-white">Personal Contact#</strong> <?php echo $row['ws_personal_contact']; ?></p>
                        ...
                        <div class="bg-secondary rounded h-100 p-0">
                            ...
                            <form action="" method="post">
                                <div class="d-flex justify-content-end">
                                    <a href="./ws-approvals.php" class="btn btn-sm btn-outline-danger me-2">Go Back</a>
